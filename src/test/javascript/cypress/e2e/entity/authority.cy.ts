...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '8ee50e7d-12ae-4650-adc2-1df933acbbc0' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('c4cb20ef-b595-405f-9fe7-0c49643ff080');
      cy.get(`[data-cy="name"]`).should('have.value', 'c4cb20ef-b595-405f-9fe7-0c49643ff080');
